        ...
        <div class="right-column">
            <form class="form" action="loginvalidation.php"  method="POST">
                <table>
                    ...
                    <tr>
                        <td><input type="email" name="email" placeholder="Enter your email" class="inputtag"  required> </td>
                    </tr>
                    <tr><td><br></td></tr>
                    <tr>
                    ...
                    <tr>
                        <!-- <td class="password-container">
                            ...
                            <td><input type="password" name="password" placeholder="Enter your Password" class="inputtag" required> </td>
                    </tr>
